...
//arrHead = ['', 'Local Govt', 'State Located', 'Actual Production (ton)']; // table headers.
//arrHead = ['Local Govt', 'State Located', 'Actual Production (ton)']; // table headers.
...
function init() {  
	...
	websocket.onopen = function(evt) {
            ...
            websocket.send("actual_prod=actual_prod&flag=APN");            
...
function generateTable(msgstr) {
    ...
    //displayMessage(data);
    var modified_data = "Local Government|State Located|Actual Production (ton)#" + data;
