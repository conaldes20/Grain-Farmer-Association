...
function init() {  
	...
	websocket.onopen = function(evt) {
            ...
            websocket.send("total_loan_recovered=total_loan_recovered&flag=TLR");            
...
function generateTable(msgstr) {
    ...
    var modified_data = "Loan Detail|Local Government|State Located|Total Loans Recovered (Nm#" + data;
